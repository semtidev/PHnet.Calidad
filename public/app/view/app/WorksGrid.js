Ext.define('PHNet.view.app.WorksGrid', {
    ...
    listeners: {
        ...
        'celldblclick': function(grid, td, cellIndex, record, tr, rowIndex, e, eOpts) {
            var id = record.data.id;                
            if (cellIndex == 3) {
                var state = record.data.metrology;
                this.fireEvent('changeStateMetrology', 'metro', id, state);
            }
            else if (cellIndex == 4) {
                var state = record.data.planning;
                this.fireEvent('changeStateMetrology', 'plan', id, state);
            }
            else if (cellIndex == 5) {
                var state = record.data.intcustomerpoll;
                this.fireEvent('changeStateMetrology', 'intcustomer', id, state);
            }
            else if (cellIndex == 6) {
                var state = record.data.extcustomerpoll;
                this.fireEvent('changeStateMetrology', 'extcustomer', id, state);
            }
        }
    },
    viewConfig: {

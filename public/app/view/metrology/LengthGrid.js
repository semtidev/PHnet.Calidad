Ext.define('PHNet.view.metrology.LengthGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.lengthgrid',
    id: 'lengthgrid',
    requires: [
        'Ext.grid.*',
        'Ext.Form.*',
    ...
    listeners: {
        ...
        'afterrender': function(grid, opt) {
            if (!localStorage.getItem('userrol')) {
                Ext.getCmp('eq_length_columndel').hide();
            }
        },
        'cellclick': function(grid, td, cellIndex, record, tr, rowIndex, e, eOpts) {
            ...
            if (cellIndex == 0) {
                ...
                if (localStorage.getItem('userrol')) {
                    var animtarget = 'photolnk-length-' + id;
                        ...
                        if (record !== null) {
                            ...
                            if (photo != null && photo != '') {
                                ...
                                if (!localStorage.getItem('userrol')) {
                                    ...
                                    return '<a id="photolnk-length-'+ record.get('id') +'" class="lnk-metrology-photo"><img src="/phnet.calidad/public/dist/img/metrology/' + val + '.jpg" width="24" height="20"></a>';
                                }                                
                            }
                            else {
                                if (parseInt(record.get('active')) == 0) {
                                ...
                                if (!localStorage.getItem('userrol')) {
                                   return '<img src="/phnet.calidad/public/dist/img/metrology/nophoto.png" width="24" height="20">';
                                    ...
                                    return '<a id="photolnk-length-'+ record.get('id') +'" class="lnk-metrology-photo"><img src="/phnet.calidad/public/dist/img/metrology/nophoto.png" width="24" height="20"></a>';
                                }                                
                            }
                        }
                    }

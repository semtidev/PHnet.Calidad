Ext.define('PHNet.view.metrology.WeightGrid', {
    ...
    listeners: {
        ...
        'afterrender': function(grid, opt) {
            if (!localStorage.getItem('userrol')) {
                Ext.getCmp('eq_weight_columndel').hide();
            }
        },
        'cellclick': function(grid, td, cellIndex, record, tr, rowIndex, e, eOpts) {
            ...
            if (cellIndex == 0) {
                ...
                if (localStorage.getItem('userrol')) {
                    var animtarget  = 'photolnk-weight-' + id;
    ...
    initComponent: function() {
                        ...
                        if (record !== null) {
                            ...
                            if (photo != null && photo != '') {
                                ...
                                if (!localStorage.getItem('userrol')) {
                                    ...
                                    return '<a id="photolnk-weight-'+ record.get('id') +'" class="lnk-metrology-photo"><img src="/phnet.calidad/public/dist/img/metrology/' + val + '.jpg" width="24" height="20"></a>';
                                }                                
                            }
                            else {
                                if (parseInt(record.get('active')) == 0) {
                                ...
                                if (!localStorage.getItem('userrol')) {
                                    ...
                                    return '<a id="photolnk-weight-'+ record.get('id') +'" class="lnk-metrology-photo"><img src="/phnet.calidad/public/dist/img/metrology/nophoto.png" width="24" height="20"></a>';
                                }
                            }
                        }
                    }
        ...
        me.on('edit', function(edt, e){
            if (!localStorage.getItem('userrol')) { return false; }            
            var record = {
                    id: e.record.data.id,

Ext.define('PHNet.view.satisfaction.PollhostGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.pollhostgrid',
    id: 'pollfeedgrid',
    requires: [
        'Ext.grid.*',
        'Ext.Form.*',
    ...
    listeners: {
        ...
        'afterrender': function(grid, opt) {
            if (!localStorage.getItem('userrol')) {
                Ext.getCmp('poll_host_columndel').hide();
            }
        },

Ext.define('PHNet.view.satisfaction.PollpersonaltranspGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.pollpersonaltranspgrid',
    id: 'pollpersonaltranspgrid',
    requires: [
        'Ext.grid.*',
        'Ext.Form.*',
        'Ext.grid.plugin.CellEditing'
    ],
    store: 'Pollpersonaltransp',
    listeners: {
        ...
        'afterrender': function(grid, opt) {
            if (!localStorage.getItem('userrol')) {
                Ext.getCmp('poll_feed_columndel').hide();
            }
        },
    ...
    initComponent: function() {
        ...
        me.columns = {
            ...
            items: [{
                    text: ' ',
                    id: 'poll_personaltransp_columndel',
                    width: 40,
                    align: 'center',
                    menuDisabled: true,
                    sortable: false,

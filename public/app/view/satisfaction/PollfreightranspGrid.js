Ext.define('PHNet.view.satisfaction.PollfreightranspGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.pollfreightranspgrid',
    id: 'pollfreightranspgrid',
    requires: [
        'Ext.grid.*',
        'Ext.Form.*',
        'Ext.grid.plugin.CellEditing'
    ],
    store: 'Pollfreightransp',
    listeners: {
    ...
    initComponent: function() {
        ...
        var me = this,
            cellEditingPlugin = Ext.create('Ext.grid.plugin.CellEditing', {
                pluginId: 'intcFreightranspGridEditing',
                clicksToEdit: 2,
                listeners: {
        ...
        me.columns = {
            ...
            items: [{
                    text: ' ',
                    id: 'poll_freightransp_columndel',
                    width: 40,
                    align: 'center',
                    menuDisabled: true,
                    sortable: false,

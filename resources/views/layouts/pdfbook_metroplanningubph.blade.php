<html lang="en">
    <head>
        ...
        <style>
            ...
            @page { margin: 158px 30px 30px 30px; }
            header {
                position: fixed;
                top: -148px;
                left: 0px;
        ...
        <header>
            ...
            <table width="100%" class="table" border="0" cellpadding="0" cellspacing="0">
                <tr height="20">
                    ...
                    <td width="50%" class="title-document" align="right" style="text-transform: normal; font-size: 12px">
                        <span>Leyenda: &nbsp;&nbsp;R - Real&nbsp;/&nbsp;PL - Plan&nbsp;/&nbsp;P - Pendiente</span>
                    </td>
                </tr>
            </table>
            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="50" class="data" align="center"><strong>Proyecto</strong></td>
                    <td class="data" align="left"><strong>Denominaci&oacute;n</strong></td>
                    <td width="100" class="data" align="center"><strong>Serie</strong></td>
                    <td width="20" class="data" align="center"><strong>Ene</strong></td>
                    <td width="20" class="data" align="center"><strong>Feb</strong></td>
                    <td width="20" class="data" align="center"><strong>Mar</strong></td>
                    <td width="20" class="data" align="center"><strong>Abr</strong></td>
                    <td width="20" class="data" align="center"><strong>May</strong></td>
                    <td width="20" class="data" align="center"><strong>Jun</strong></td>
                    <td width="20" class="data" align="center"><strong>Jul</strong></td>
                    <td width="20" class="data" align="center"><strong>Ago</strong></td>
                    <td width="20" class="data" align="center"><strong>Sep</strong></td>
                    <td width="20" class="data" align="center"><strong>Oct</strong></td>
                    <td width="20" class="data" align="center"><strong>Nov</strong></td>
                    <td width="20" class="data" align="center"><strong>Dic</strong></td>
                </tr>
            </table>
        </header>

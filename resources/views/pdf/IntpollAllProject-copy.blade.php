...
@section('content')
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td width="80" rowspan="2" class="title-table" align="center">Promedio</td>
        </tr>
        <tr>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td width="50" class="title-table" align="center">7</td>
            <td width="50" class="title-table" align="center">8</td>
        </tr>
        @php $count = 0; @endphp

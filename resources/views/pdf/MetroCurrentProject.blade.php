...
@section('title', 'Plantilla IM Proyecto')
    ...
    <table class="table" border="1" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <tr>
                ...
                <td width="50" class="column-title" rowspan="2">Modelo</td>
                <td width="60" class="column-title" rowspan="2" align="center">
                    Rango de Medici&oacute;n
                </td>
                <td width="60" class="column-title" rowspan="2" align="center">Exactitud</td>
    ...
    <table class="table" border="1" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <tr>
                <td width="10" class="column-title" rowspan="2" align="center">No.</td>
                <td width="40" class="column-title" rowspan="2" align="center">C&oacute;digo</td>
                <td width="70" class="column-title" rowspan="2">Denominaci&oacute;n</td>
                <td width="50" class="column-title" rowspan="2">Modelo</td>
                <td width="60" class="column-title" rowspan="2" align="center">
                    Rango de Medici&oacute;n
                </td>
                <td width="80" class="column-title" rowspan="2" align="center">Exactitud</td>
                <td class="column-title" colspan="2" align="center">Cantidad</td>
                <td width="80" class="column-title" rowspan="2">Observaciones</td>
            </tr>
            <tr>
            ...
            @foreach ($elect as $key => $data)
                @php $count++; @endphp
                <tr>
                    <td class="data" style="text-align:center;" valign="top">
                        {{ $count }}
                    </td>
                    <td class="data" style="text-align:center;" valign="top">
                        {{ $elect_code }}
        ...
        <thead>
            <tr>
                <th colspan="9">
                    ...
                    <table width="70%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="table-title3">Especialidad: Longitud</td>
                            <td class="table-title3">Plantilla No: 5</td>
                        </tr>
                    </table>
                </th>
            </tr>

...
@section('content')
    ...
    $div_par = ($division % 2 > 0) ? false : true;
    if (!$div_par) {
        $division--;
    }
    $table = 0;
    @endphp
    {{ $divisor .' - '. $division .' - '. $module }}
            ...
            <td width="48%">
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td width="20" class="title-table" align="center">6</td>
                    </tr>
                    ...
                    @if ($count > ($m * $divisor) && $count < (($m + 1) * $divisor) + 1)
                        @if ($data['number'] != null)
            ...
            <td width="48%">
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td width="22" class="title-table" align="center">6</td>
                    </tr>
                    ...
                    @if ($count > ($m + 1) * $divisor && $count < (($m + 2) * $divisor) + 1)
                        @if ($data['number'] != null)
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="title-category">
                Evaluaci&oacute;n del Servicio: Alojamiento
            </td>
            <td class="title-category" align="right">
                Fecha: {{ month_name(intval($month)).' '.$year }}
            </td>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="title-category">
                Evaluaci&oacute;n del Servicio: Recreaci&oacute;n
            </td>
            <td class="title-category" align="right">
                Fecha: {{ month_name(intval($month)).' '.$year }}
            </td>
    ...
    @php
    $pollrecr_count = count($pollrecr);
    $divisor = (intval($pollrecr_count / 2) <= 30) ? intval($pollrecr_count / 2) : 30;
    $division = intval($pollrecr_count / $divisor);
    $module = $pollrecr_count % $divisor;
    @endphp
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="48%">    
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="40" class="title-table" rowspan="2" align="center">No.</td>
                        <td colspan="2" class="title-table" align="center">No. Pregunta</td>
                        <td width="40" rowspan="2" class="title-table" align="center">Total</td>
                        <td rowspan="2" class="title-table" align="center">Prom</td>
                    </tr>
                    <tr>
                        <td width="30" class="title-table" align="center">7</td>
                        <td width="30" class="title-table" align="center">8</td>
                    </tr>
                    @php $count = 0; @endphp
                    @foreach ($pollrecr as $key => $data)
                    @php $count++; @endphp
    ...
    <table width="100%" class="table-footer" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="title-category" width="150">
                PROMEDIO TOTAL:&nbsp; <strong>{{ $recr_total_prom }}</strong>
            </td>
            <td class="title-category">
                CALIFICACI&Oacute;N OBTENIDA:&nbsp; <strong>{{ $recr_eval }}</strong>
            </td>
        </tr>
    </table>
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="title-category" colspan="2">
                <strong>Aspectos Evaluados:</strong><br>
                @php $no_quest = 0; @endphp
                @foreach ($recr_questions as $question)
                    @php $no_quest++; @endphp
                    {!! '&nbsp;&nbsp;&nbsp;' . $no_quest . '. ' . $question->question . '<br>' !!}  
                @endforeach
            </td>
    ...
    @if (count($recr_issues) > 0)
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="title-category" colspan="2">
                <strong>Aspectos a Mejorar:</strong><br>
                @php $no_quest = 0; @endphp
                @foreach ($recr_issues as $key => $value)
                    @php $no_quest++; @endphp
                    {!! '&nbsp;&nbsp;&nbsp;' . $no_quest . '. ' . $value . '<br>' !!}  
                @endforeach
            </td>
    ...
    @endif
    @if (count($recr_comments) > 0)
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="title-category" colspan="2">
                <strong>Observaciones:</strong><br>
                @php $no_quest = 0; @endphp
                @foreach ($recr_comments as $row)
                    @php $no_quest++; @endphp
                    {!! '&nbsp;&nbsp;&nbsp;' . $no_quest . '. ' . $row->comment . '<br>' !!}  
                @endforeach
            </td>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="title-category">
                Tipo de Cliente: Cliente Interno (UB Equipos)
            </td>
            <td class="title-category" align="right">
                Lugar: {{ $company['name'] }}
            </td>
